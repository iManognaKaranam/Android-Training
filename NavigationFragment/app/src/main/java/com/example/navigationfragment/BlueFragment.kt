...
class BlueFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var resText = view.findViewById<TextView>(R.id.textViewNameBlue)
        var resText1 = view.findViewById<TextView>(R.id.textViewPasswordBlue)
        var data1 = arguments?.getString("key1")
        var data2 = arguments?.getString("key2")
        resText.setText(data1)
        resText1.setText(data2)
        return view
